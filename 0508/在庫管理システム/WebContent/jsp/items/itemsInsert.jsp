...
<body>
	...
	<table>
		...
		<tr>
			<td>商品名</td>
			<td><input type="text" name="item_name" class="itemName" value="<%=request.getAttribute("item_name") %>" ></td>
		</tr>
		<tr>
			<td>商品単価</td>
		...
		<tr>
			...
			<input type="hidden" value= <%=request.getAttribute("stock_qty") %> name="stock_qty" >
			</td>
		</tr>
	</table>
	<input type="hidden" value= <%=request.getAttribute("flag") %> name="flag" >
