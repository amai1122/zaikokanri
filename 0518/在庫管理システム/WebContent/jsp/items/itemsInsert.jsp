...
<body>
	<h1>商品登録・編集</h1>
	<!-- エラーがあるかを確認する ****************************************** -->
	<c:set var="errorList" value="${errorList }"></c:set>
		...
		<table>
			<tr>
				...
				<td><input type="text" name="item_id"
					value= <c:out value="${param['item_id']}" />></td>
			</tr>
			<tr>
				<td>商品名</td>
				<td>
			...
			<tr>
				<td>商品単価</td>
				<td><input type="text" name="item_price" value=<c:out value="${item_price}" />></td>
			</tr>
			<tr>
				<td>商品原価</td>
				<td><input type="text" name="cost_price" value=<c:out value="${cost_price}" />></td>
			</tr>
			<tr>
				<td>在庫数</td>
